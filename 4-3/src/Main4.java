...
public class Main4 {
    ...
    public static void main(String[] args) {
       // 開始・終了の日時をLocalDateTimeで作成
        LocalDateTime localStart = LocalDateTime.of(2024, 7, 1, 10, 0);
        LocalDateTime localEnd = LocalDateTime.of(2024, 7, 15, 22, 0);

        // LocalDateTimeをZonedDateTimeに変換
        ZonedDateTime start = ZonedDateTime.of(localStart, ZoneId.of("Asia/Tokyo"));
        ZonedDateTime end = ZonedDateTime.of(localEnd, ZoneId.of("Asia/Tokyo"));
